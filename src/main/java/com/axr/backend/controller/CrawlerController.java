...
import static com.axr.backend.utils.Utils.*;
...
public class CrawlerController {
    ...
    public static final String CONTENT_TYPE_ERROR_MESSAGE = "Content-Type must be application/json";
    public static final String BAD_REQUEST_ID_MESSAGE = "The ID generated by the search must be sended in the path with 8 characters";
    ...
    public String getById(Request req, Response response) {
        ...
        try {
            ...
            if(id == null || id.isBlank() || id.length() != 8){
                log.warning("GET - " + BAD_REQUEST_ID_MESSAGE);
                return setErrorResponse(400,  response, BAD_REQUEST_ID_MESSAGE);
            }
    ...
    public static JsonObject getJsonObject(Request request) {
        ...
        if (contentType == null || !contentType.startsWith("application/json")) {
            throw new IllegalArgumentException(CONTENT_TYPE_ERROR_MESSAGE);
        }
